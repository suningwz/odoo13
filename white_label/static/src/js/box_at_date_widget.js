odoo.define('white_label.boxAtDateWidget', function (require) {
"use strict";
...
var BoxAtDateWidget = Widget.extend({ 
    template: 'white_label.boxAtDate',
    ...
    _setPopOvers: function () {
        var self = this;
        var $content = $(QWeb.render('white_label.BoxDetailPopOver', {
            data: this.data,
        }));
...
widget_registry.add('box_at_date_widget', BoxAtDateWidget);

return BoxAtDateWidget;
});
